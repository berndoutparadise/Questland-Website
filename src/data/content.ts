...
const shared = {
  de: {
    ...
    questlog: {
      ...
      selectedText: "Der Questgeber hat diese drei Spielarten für eure Gruppe ausgewählt.",
      moreHeading: "WEITERE SPIELARTEN",
  ...
  en: {
    ...
    questlog: {
      ...
      selectedText: "The quest giver selected these three game types for your group.",
      moreHeading: "MORE GAME TYPES",
